    ...
    <script>
        new Vue({
            ...
            methods: {
                async fetchData() {
                    try {
                        const response = await fetch('http://localhost:8080/documentacion/getClimaByUbicacionDia?ubicacion=San%20V%C3%ADctor%20de%20la%20Monta%C3%B1a&fecha=2024-02-03');
